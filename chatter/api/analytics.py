...
async def get_conversation_stats(
    ...
    try:
        ...
        return ConversationStatsResponse(
            ...
            conversations_by_date=stats.get("conversations_by_date", {}),
...
async def get_usage_metrics(
    ...
    try:
        ...
        return UsageMetricsResponse(
            ...
            response_times_by_model=metrics.get("response_times_by_model", {}),
...
async def get_performance_metrics(
    ...
    try:
        ...
        return PerformanceMetricsResponse(
            ...
            performance_by_model=metrics.get("performance_by_model", {}),
            performance_by_provider=metrics.get("performance_by_provider", {}),
            database_response_time_ms=metrics.get("database_response_time_ms", 0.0),
...
async def get_document_analytics(
    ...
    try:
        ...
        return DocumentAnalyticsResponse(
            ...
            avg_processing_time_seconds=analytics.get("avg_processing_time_seconds", 0.0),
            processing_success_rate=analytics.get("processing_success_rate", 0.0),
            total_chunks=analytics.get("total_chunks", 0),
            avg_chunks_per_document=analytics.get("avg_chunks_per_document", 0.0),
            total_storage_bytes=analytics.get("total_storage_bytes", 0),
            avg_document_size_bytes=analytics.get("avg_document_size_bytes", 0.0),
            ...
            popular_search_terms=analytics.get("popular_search_terms", {}),
...
async def get_system_analytics(
    ...
    try:
        ...
        return SystemAnalyticsResponse(
            ...
            system_uptime_seconds=analytics.get("system_uptime_seconds", 0.0),
            avg_cpu_usage=analytics.get("avg_cpu_usage", 0.0),
            avg_memory_usage=analytics.get("avg_memory_usage", 0.0),
            database_connections=analytics.get("database_connections", 0),
            total_api_requests=analytics.get("total_api_requests", 0),
            requests_per_endpoint=analytics.get("requests_per_endpoint", {}),
            avg_api_response_time=analytics.get("avg_api_response_time", 0.0),
...
async def get_dashboard(
    ...
    try:
        ...
        return DashboardResponse(
            ...
            performance_metrics=PerformanceMetricsResponse(**dashboard_data.get("performance_metrics", {})),
