"""Command-line interface for Chatter - API-only version."""

# Import the new API-only CLI
from chatter.api_cli import app
...
def generate_sdk(
    language: str = typer.Option(
        ...
        "--language",
        "-l",
        help="SDK language: python, typescript, or all",
    ),
    output_dir: str = typer.Option(
    ...
    try:
        ...
        if success:
            ...
            console.print("❌ SDK generation completed with errors!")
            raise typer.Exit(1) from None
