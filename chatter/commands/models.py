...
async def create_provider(
    ...
    async with get_client() as sdk_client:
        ...
        console.print(f"✅ [green]Created provider: {response.display_name}[/green]")
        console.print(f"[dim]ID: {response.id}[/dim]")


@models_app.command("provider-show")
@run_async
async def show_provider(provider_id: str = typer.Argument(..., help="Provider ID")):
...
async def update_provider(
    ...
    api_key_required: bool = typer.Option(None, help="Whether API key is required"),
    base_url: str = typer.Option(None, help="New base URL"),
    is_active: bool = typer.Option(None, help="Whether provider is active"),
    is_default: bool = typer.Option(None, help="Whether this is the default provider"),
):
    """Update a provider."""
    ...
    async with get_client() as sdk_client:
        ...
        console.print(f"✅ [green]Updated provider: {response.display_name}[/green]")
...
async def create_model(
    ...
    async with get_client() as sdk_client:
        ...
        console.print(f"✅ [green]Created model: {response.display_name}[/green]")
        console.print(f"[dim]ID: {response.id}[/dim]")


@models_app.command("model-show")
@run_async
async def show_model_detailed(model_id: str = typer.Argument(..., help="Model ID")):
    """Show detailed model information."""
    async with get_client() as sdk_client:
        response = await sdk_client.model_registry_api.get_model_api_v1_models_models_model_id_get(
            model_id=model_id
...
async def create_embedding_space(
    ...
    model_id: str = typer.Option(..., help="Model ID to use for embeddings"),
    ...
    async with get_client() as sdk_client:
        ...
        console.print(f"✅ [green]Created embedding space: {response.name}[/green]")
        console.print(f"[dim]ID: {response.id}[/dim]")


@models_app.command("embedding-space-show")
@run_async
async def show_embedding_space(space_id: str = typer.Argument(..., help="Embedding space ID")):
...
async def update_embedding_space(
    space_id: str = typer.Argument(..., help="Embedding space ID to update"),
    ...
    async with get_client() as sdk_client:
        ...
        console.print(f"✅ [green]Updated embedding space: {response.name}[/green]")


@models_app.command("embedding-space-delete")
@run_async
async def delete_embedding_space(
    space_id: str = typer.Argument(..., help="Embedding space ID to delete"),
    force: bool = typer.Option(False, help="Skip confirmation prompt"),
):
    ...
    async with get_client() as sdk_client:
        ...
        console.print(f"✅ [green]Deleted embedding space {space_id}[/green]")
