...
class Settings(BaseSettings):
    ...
    openai_model: str = Field(
        default="gpt-4o", description="OpenAI model"
    )
    ...
    openai_max_tokens: int = Field(
        default=4096, description="OpenAI max tokens"
    )
    openai_temperature: float = Field(
        default=0.7, description="OpenAI temperature"
    )
    openai_timeout: int = Field(
        default=60, description="OpenAI timeout"
    )
    ...
    anthropic_max_tokens: int = Field(
        default=4096, description="Anthropic max tokens"
    )
    anthropic_temperature: float = Field(
        default=0.7, description="Anthropic temperature"
    )
    anthropic_timeout: int = Field(
        default=60, description="Anthropic timeout"
    )
    ...
    google_embedding_dimensions: int = Field(
        default=768, description="Google embedding dimensions"
    )
    ...
    cohere_embedding_dimensions: int = Field(
        default=384, description="Cohere embedding dimensions"
    )
    ...
    default_embedding_provider: str = Field(
        default="openai", description="Default embedding provider"
    )
