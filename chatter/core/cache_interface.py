...
class CacheInterface(ABC):
    ...
    async def get_or_set(self, key: str, callable_func, ttl: Optional[int] = None) -> Any:
    ...
    async def warm_cache(self, data: Dict[str, Any], ttl: Optional[int] = None) -> bool:
    ...
    def _update_stats(self, hit: bool = False, miss: bool = False, error: bool = False):
