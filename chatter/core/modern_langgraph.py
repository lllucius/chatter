"""Modern LangGraph workflow manager with flexible node support.

This replaces the hardcoded approach in the original LangGraphWorkflowManager
with a flexible system that supports all defined node types including
conditional, loop, variable, and error handler nodes.
"""
...
class ModernLangGraphWorkflowManager:
    """Modern workflow manager with flexible node support."""
...
modern_workflow_manager = ModernLangGraphWorkflowManager()