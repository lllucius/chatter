...
class PlainWorkflowExecutor(BaseWorkflowExecutor):
    ...
    async def execute_streaming(
        ...
        try:
            ...
            raise WorkflowExecutionError(f"Plain workflow streaming failed: {str(e)}") from e
        finally:
            # Clean up resource tracking
            if user_id:
                self.limit_manager.end_workflow_tracking(workflow_id, user_id)
...
class RAGWorkflowExecutor(BaseWorkflowExecutor):
    ...
    async def execute(
        ...
        try:
            ...
            raise WorkflowExecutionError(f"RAG workflow execution failed: {str(e)}") from e
        finally:
            # Clean up resource tracking
            if user_id:
                self.limit_manager.end_workflow_tracking(workflow_id, user_id)
...
class ToolsWorkflowExecutor(BaseWorkflowExecutor):
    ...
    async def execute(
        ...
        try:
            ...
            raise WorkflowExecutionError(f"Tools workflow execution failed: {str(e)}") from e
        finally:
            # Clean up resource tracking
            if user_id:
                self.limit_manager.end_workflow_tracking(workflow_id, user_id)
    ...
    async def execute_streaming(
        ...
        try:
            ...
            raise WorkflowExecutionError(f"Tools workflow streaming failed: {str(e)}") from e
        finally:
            # Clean up resource tracking
            if user_id:
                self.limit_manager.end_workflow_tracking(workflow_id, user_id)
...
class FullWorkflowExecutor(BaseWorkflowExecutor):
    ...
    async def execute(
        ...
        try:
            ...
            raise WorkflowExecutionError(f"Full workflow execution failed: {str(e)}") from e
        finally:
            # Clean up resource tracking
            if user_id:
                self.limit_manager.end_workflow_tracking(workflow_id, user_id)
    ...
    async def execute_streaming(
        ...
        try:
            ...
            raise WorkflowExecutionError(f"Full workflow streaming failed: {str(e)}") from e
        finally:
            # Clean up resource tracking
            if user_id:
                self.limit_manager.end_workflow_tracking(workflow_id, user_id)
