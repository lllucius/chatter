...
from sqlalchemy import JSON, Column, String, Float, Integer, Boolean, Text, Enum as SQLEnum
from sqlalchemy.orm import Mapped, mapped_column
from sqlalchemy.dialects.postgresql import JSONB, ARRAY

from chatter.models.base import Base
from chatter.schemas.agents import AgentType, AgentStatus, AgentCapability
...
class AgentDB(Base):
    ...
    personality_traits: Mapped[list[str]] = mapped_column(ARRAY(String), default=list)
    knowledge_domains: Mapped[list[str]] = mapped_column(ARRAY(String), default=list)
    response_style: Mapped[str] = mapped_column(String(100), default="professional")
    ...
    # Model configuration
    primary_llm: Mapped[str] = mapped_column(String(100), default="openai")
    fallback_llm: Mapped[str] = mapped_column(String(100), default="anthropic")
    temperature: Mapped[float] = mapped_column(Float, default=0.7)
    max_tokens: Mapped[int] = mapped_column(Integer, default=4096)

    # Performance settings
    max_conversation_length: Mapped[int] = mapped_column(Integer, default=50)
    context_window_size: Mapped[int] = mapped_column(Integer, default=4000)
    ...
    adaptation_threshold: Mapped[float] = mapped_column(Float, default=0.8)

    # Metadata
    created_by: Mapped[str] = mapped_column(String(26), nullable=False, default="system")
    tags: Mapped[list[str]] = mapped_column(ARRAY(String), default=list)
    agent_metadata: Mapped[dict[str, Any]] = mapped_column(JSONB, default=dict)
