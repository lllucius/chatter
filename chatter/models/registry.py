...
class ModelDef(Base):
    ...
    dimensions: Mapped[int | None] = mapped_column(Integer)  # for embedding models
...
class EmbeddingSpace(Base):
    ...
    reducer_path: Mapped[str | None] = mapped_column(String(500))  # path to joblib reducer file
    reducer_version: Mapped[str | None] = mapped_column(String(100))  # version/hash of reducer
