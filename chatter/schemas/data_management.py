...
from chatter.services.data_management import DataFormat, ExportScope, BackupType
from chatter.schemas.common import GetRequestBase, ListRequestBase
...
class ExportDataRequest(BaseModel):
    ...
    custom_query: Optional[Dict[str, Any]] = Field(None, description="Custom export query")
...
class BackupResponse(BaseModel):
    ...
    record_count: Optional[int] = Field(None, description="Number of records backed up")
