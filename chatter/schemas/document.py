...
class DocumentListRequest(BaseModel):
    ...
    tags: Optional[List[str]] = Field(None, description="Filter by tags")
    owner_id: Optional[str] = Field(None, description="Filter by owner (admin only)")
...
class DocumentChunkResponse(BaseModel):
    ...
    extra_metadata: Optional[Dict[str, Any]] = Field(None, description="Chunk metadata")
...
class DocumentProcessingRequest(BaseModel):
    ...
    chunk_overlap: Optional[int] = Field(None, ge=0, le=2000, description="Override chunk overlap")
