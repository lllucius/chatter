...
class ToolServerUpdate(BaseModel):
    ...
    auto_start: Optional[bool] = Field(None)
    auto_update: Optional[bool] = Field(None)
    max_failures: Optional[int] = Field(None, ge=1, le=10)
...
class ServerToolBase(BaseModel):
    ...
    args_schema: Optional[Dict[str, Any]] = Field(None, description="Tool arguments schema")
...
class ServerToolUpdate(BaseModel):
    ...
    display_name: Optional[str] = Field(None, min_length=1, max_length=200)
    description: Optional[str] = Field(None)
    status: Optional[ToolStatus] = Field(None)
    bypass_when_unavailable: Optional[bool] = Field(None)
...
class ServerToolResponse(ServerToolBase):
    ...
    last_called: Optional[datetime] = Field(None, description="Last call timestamp")
...
class ToolServerResponse(ToolServerBase):
    ...
    last_startup_success: Optional[datetime] = Field(None, description="Last successful startup")
    last_startup_error: Optional[str] = Field(None, description="Last startup error")
...
class ToolServerMetrics(BaseModel):
    ...
    uptime_percentage: Optional[float] = Field(None, ge=0, le=1, description="Uptime percentage")
