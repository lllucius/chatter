...
from chatter.schemas.toolserver import (
    ...
    ServerToolResponse, ToolUsageCreate, ToolServerMetrics,
    ToolMetrics, ToolServerAnalytics, ToolServerHealthCheck
)
...
class ToolServerService:
    ...
    async def get_server(self, server_id: str) -> Optional[ToolServerResponse]:
    ...
    async def get_server_by_name(self, name: str) -> Optional[ToolServerResponse]:
    ...
    async def get_server_analytics(self, server_id: str) -> Optional[ToolServerMetrics]:
    ...
    async def _start_server_internal(self, server: ToolServer) -> bool:
        ...
        try:
            ...
            if success:
                server.status = ServerStatus.ENABLED
                server.last_startup_success = datetime.now(timezone.utc)
