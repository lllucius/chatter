"""Simplified workflow execution service using strategy pattern.
...
class SimplifiedWorkflowExecutionService:
    """Simplified service for executing chat workflows using strategy pattern."""
