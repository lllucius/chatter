...
class MemoryMonitor:
    ...
    def __init__(self, max_memory_mb: int | None = None):
        ...
        """
        self.max_memory_mb = max_memory_mb or (settings.max_memory_per_document // 1024 // 1024)
...
async def check_memory_before_operation(operation: str, min_free_mb: int = 100) -> None:
    ...
    try:
        ...
        logger.warning("Memory check failed", operation=operation, error=str(e))
