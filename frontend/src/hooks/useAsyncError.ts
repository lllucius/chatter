...
import { errorHandler, ErrorContext, ErrorHandlerOptions } from '../utils/error-handler';
...
export function useAsyncError() {
   ...
   */
  const createSafeAsyncFunction = useCallback(<T extends (...args: unknown[]) => Promise<unknown>>(
    fn: T,
    context: ErrorContext,
    options?: ErrorHandlerOptions
  ) => {
