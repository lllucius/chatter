...
export interface RefreshTokenApiV1AuthRefreshPostRequest {
...
export interface AuthenticationApiInterface {
     ...
     * @memberof AuthenticationApiInterface
     */
    refreshTokenApiV1AuthRefreshPostRaw(requestParameters: RefreshTokenApiV1AuthRefreshPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TokenRefreshResponse>>;

    /**
     * Refresh access token with enhanced security validation.  Args:     token_data: Refresh token data     request: HTTP request for security logging     auth_service: Authentication service  Returns:     New access and refresh tokens
     * Refresh Token
     */
    refreshTokenApiV1AuthRefreshPost(requestParameters: RefreshTokenApiV1AuthRefreshPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TokenRefreshResponse>;
...
export class AuthenticationApi extends runtime.BaseAPI implements AuthenticationApiInterface {
     ...
     * Refresh Token
     */
    async refreshTokenApiV1AuthRefreshPostRaw(requestParameters: RefreshTokenApiV1AuthRefreshPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TokenRefreshResponse>> {
        if (requestParameters['tokenRefresh'] == null) {
            throw new runtime.RequiredError(
                'tokenRefresh',
                'Required parameter "tokenRefresh" was null or undefined when calling refreshTokenApiV1AuthRefreshPost().'
            );
        }
     ...
     * Refresh Token
     */
    async refreshTokenApiV1AuthRefreshPost(requestParameters: RefreshTokenApiV1AuthRefreshPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TokenRefreshResponse> {
        const response = await this.refreshTokenApiV1AuthRefreshPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
