...
from scripts.utils.config import PythonSDKConfig, get_openapi_generator_config
...
class PythonSDKGenerator:
    ...
    def _generate(self) -> bool:
        ...
        try:
            ...
            print(f"🐍 Generating Python SDK in {self.config.output_dir}")
            ...
            if result.returncode != 0:
                print(f"❌ OpenAPI Generator failed:")
    ...
    def validate(self) -> bool:
        ...
        try:
            ...
            api_dir = self.config.output_dir / self.config.package_name / "api"
            if api_dir.exists():
    ...
    def _find_openapi_spec(self) -> Optional[Path]:
