...
from ...models.ab_test_create_request import ABTestCreateRequest
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ABTestResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        body (ABTestCreateRequest): Request schema for creating an A/B test.
