...
) -> Optional[Union[ConversationStatsResponse, HTTPValidationError]]:
    if response.status_code == 200:
        response_200 = ConversationStatsResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ConversationStatsResponse, HTTPValidationError]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ConversationStatsResponse, HTTPValidationError]
    """
