...
from ...models.model_def_create import ModelDefCreate
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ModelDefWithProvider.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        body (ModelDefCreate): Schema for creating a model definition.
