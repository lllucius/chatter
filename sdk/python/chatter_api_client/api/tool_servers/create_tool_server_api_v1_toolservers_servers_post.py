...
from ...models.tool_server_create import ToolServerCreate
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ToolServerResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        body (ToolServerCreate): Schema for creating a tool server.
