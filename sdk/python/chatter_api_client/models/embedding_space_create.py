...
if TYPE_CHECKING:
    from ..models.embedding_space_create_index_config import EmbeddingSpaceCreateIndexConfig


T = TypeVar("T", bound="EmbeddingSpaceCreate")


@_attrs_define
class EmbeddingSpaceCreate:
    ...
    Attributes:
        ...
        index_config (Union[Unset, EmbeddingSpaceCreateIndexConfig]): Index configuration
    ...
    index_config: Union[Unset, "EmbeddingSpaceCreateIndexConfig"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        index_config: Union[Unset, EmbeddingSpaceCreateIndexConfig]
        if isinstance(_index_config, Unset):
            index_config = UNSET
        else:
            index_config = EmbeddingSpaceCreateIndexConfig.from_dict(_index_config)

        is_active = d.pop("is_active", UNSET)

        is_default = d.pop("is_default", UNSET)

        embedding_space_create = cls(
            name=name,
            display_name=display_name,
            base_dimensions=base_dimensions,
            effective_dimensions=effective_dimensions,
        ...
        embedding_space_create.additional_properties = d
        return embedding_space_create
