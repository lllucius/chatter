...
if TYPE_CHECKING:
    from ..models.model_def_with_provider_default_config import ModelDefWithProviderDefaultConfig
    from ..models.provider import Provider


T = TypeVar("T", bound="ModelDefWithProvider")


@_attrs_define
class ModelDefWithProvider:
    ...
    Attributes:
        ...
        provider (Provider): Full provider schema.
        ...
        default_config (Union[Unset, ModelDefWithProviderDefaultConfig]): Default configuration
    ...
    default_config: Union[Unset, "ModelDefWithProviderDefaultConfig"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        default_config: Union[Unset, ModelDefWithProviderDefaultConfig]
        if isinstance(_default_config, Unset):
            default_config = UNSET
        else:
            default_config = ModelDefWithProviderDefaultConfig.from_dict(_default_config)

        is_active = d.pop("is_active", UNSET)

        is_default = d.pop("is_default", UNSET)

        model_def_with_provider = cls(
            name=name,
            model_type=model_type,
            display_name=display_name,
            model_name=model_name,
        ...
        model_def_with_provider.additional_properties = d
        return model_def_with_provider
