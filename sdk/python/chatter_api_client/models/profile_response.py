...
if TYPE_CHECKING:
    from ..models.profile_response_extra_metadata_type_0 import ProfileResponseExtraMetadataType0
    from ..models.profile_response_logit_bias_type_0 import ProfileResponseLogitBiasType0
...
class ProfileResponse:
    ...
    Attributes:
        ...
        logit_bias (Union['ProfileResponseLogitBiasType0', None, Unset]): Logit bias adjustments
        ...
        extra_metadata (Union['ProfileResponseExtraMetadataType0', None, Unset]): Additional metadata
        last_used_at (Union[None, Unset, datetime.datetime]): Last usage time
    """
    ...
    logit_bias: Union["ProfileResponseLogitBiasType0", None, Unset] = UNSET
    ...
    extra_metadata: Union["ProfileResponseExtraMetadataType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.logit_bias, Unset):
            logit_bias = UNSET
        elif isinstance(self.logit_bias, ProfileResponseLogitBiasType0):
        ...
        elif isinstance(self.extra_metadata, ProfileResponseExtraMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_logit_bias(data: object) -> Union["ProfileResponseLogitBiasType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                logit_bias_type_0 = ProfileResponseLogitBiasType0.from_dict(data)

                return logit_bias_type_0
            except:  # noqa: E722
                pass
            return cast(Union["ProfileResponseLogitBiasType0", None, Unset], data)
        ...
        def _parse_extra_metadata(data: object) -> Union["ProfileResponseExtraMetadataType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extra_metadata_type_0 = ProfileResponseExtraMetadataType0.from_dict(data)

                return extra_metadata_type_0
            except:  # noqa: E722
                pass
            return cast(Union["ProfileResponseExtraMetadataType0", None, Unset], data)
