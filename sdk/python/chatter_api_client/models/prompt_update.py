...
if TYPE_CHECKING:
    from ..models.prompt_update_chain_steps_type_0_item import PromptUpdateChainStepsType0Item
    from ..models.prompt_update_examples_type_0_item import PromptUpdateExamplesType0Item
    from ..models.prompt_update_extra_metadata_type_0 import PromptUpdateExtraMetadataType0
    from ..models.prompt_update_input_schema_type_0 import PromptUpdateInputSchemaType0
    from ..models.prompt_update_output_schema_type_0 import PromptUpdateOutputSchemaType0
    from ..models.prompt_update_test_cases_type_0_item import PromptUpdateTestCasesType0Item
...
class PromptUpdate:
    ...
    Attributes:
        name (Union[None, Unset, str]): Prompt name
        description (Union[None, Unset, str]): Prompt description
        prompt_type (Union[None, PromptType, Unset]): Prompt type
        category (Union[None, PromptCategory, Unset]): Prompt category
        content (Union[None, Unset, str]): Prompt content/template
        variables (Union[None, Unset, list[str]]): Template variables
        template_format (Union[None, Unset, str]): Template format
        input_schema (Union['PromptUpdateInputSchemaType0', None, Unset]): Input validation schema
        output_schema (Union['PromptUpdateOutputSchemaType0', None, Unset]): Output validation schema
        ...
        examples (Union[None, Unset, list['PromptUpdateExamplesType0Item']]): Usage examples
        test_cases (Union[None, Unset, list['PromptUpdateTestCasesType0Item']]): Test cases
        ...
        is_chain (Union[None, Unset, bool]): Whether this is a chain prompt
        chain_steps (Union[None, Unset, list['PromptUpdateChainStepsType0Item']]): Chain execution steps
        parent_prompt_id (Union[None, Unset, str]): Parent prompt ID
        is_public (Union[None, Unset, bool]): Whether prompt is public
        tags (Union[None, Unset, list[str]]): Prompt tags
        extra_metadata (Union['PromptUpdateExtraMetadataType0', None, Unset]): Additional metadata
    """
    ...
    template_format: Union[None, Unset, str] = UNSET
    input_schema: Union["PromptUpdateInputSchemaType0", None, Unset] = UNSET
    output_schema: Union["PromptUpdateOutputSchemaType0", None, Unset] = UNSET
    ...
    examples: Union[None, Unset, list["PromptUpdateExamplesType0Item"]] = UNSET
    test_cases: Union[None, Unset, list["PromptUpdateTestCasesType0Item"]] = UNSET
    ...
    is_chain: Union[None, Unset, bool] = UNSET
    chain_steps: Union[None, Unset, list["PromptUpdateChainStepsType0Item"]] = UNSET
    parent_prompt_id: Union[None, Unset, str] = UNSET
    is_public: Union[None, Unset, bool] = UNSET
    tags: Union[None, Unset, list[str]] = UNSET
    extra_metadata: Union["PromptUpdateExtraMetadataType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.category, Unset):
            category = UNSET
        elif isinstance(self.category, PromptCategory):
        ...
        template_format: Union[None, Unset, str]
        if isinstance(self.template_format, Unset):
        ...
        if isinstance(self.input_schema, Unset):
            input_schema = UNSET
        elif isinstance(self.input_schema, PromptUpdateInputSchemaType0):
        ...
        if isinstance(self.output_schema, Unset):
            output_schema = UNSET
        elif isinstance(self.output_schema, PromptUpdateOutputSchemaType0):
        ...
        is_chain: Union[None, Unset, bool]
        if isinstance(self.is_chain, Unset):
            is_chain = UNSET
        else:
        ...
        elif isinstance(self.extra_metadata, PromptUpdateExtraMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_category(data: object) -> Union[None, PromptCategory, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                category_type_0 = PromptCategory(data)

                return category_type_0
            except:  # noqa: E722
                pass
            return cast(Union[None, PromptCategory, Unset], data)
        ...
        def _parse_template_format(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        template_format = _parse_template_format(d.pop("template_format", UNSET))

        def _parse_input_schema(data: object) -> Union["PromptUpdateInputSchemaType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                input_schema_type_0 = PromptUpdateInputSchemaType0.from_dict(data)

                return input_schema_type_0
            except:  # noqa: E722
                pass
            return cast(Union["PromptUpdateInputSchemaType0", None, Unset], data)

        input_schema = _parse_input_schema(d.pop("input_schema", UNSET))

        def _parse_output_schema(data: object) -> Union["PromptUpdateOutputSchemaType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                output_schema_type_0 = PromptUpdateOutputSchemaType0.from_dict(data)

                return output_schema_type_0
            except:  # noqa: E722
                pass
            return cast(Union["PromptUpdateOutputSchemaType0", None, Unset], data)
        ...
        def _parse_examples(data: object) -> Union[None, Unset, list["PromptUpdateExamplesType0Item"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for examples_type_0_item_data in _examples_type_0:
                    examples_type_0_item = PromptUpdateExamplesType0Item.from_dict(examples_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list["PromptUpdateExamplesType0Item"]], data)

        examples = _parse_examples(d.pop("examples", UNSET))

        def _parse_test_cases(data: object) -> Union[None, Unset, list["PromptUpdateTestCasesType0Item"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for test_cases_type_0_item_data in _test_cases_type_0:
                    test_cases_type_0_item = PromptUpdateTestCasesType0Item.from_dict(test_cases_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list["PromptUpdateTestCasesType0Item"]], data)
        ...
        def _parse_is_chain(data: object) -> Union[None, Unset, bool]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        is_chain = _parse_is_chain(d.pop("is_chain", UNSET))

        def _parse_chain_steps(data: object) -> Union[None, Unset, list["PromptUpdateChainStepsType0Item"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for chain_steps_type_0_item_data in _chain_steps_type_0:
                    chain_steps_type_0_item = PromptUpdateChainStepsType0Item.from_dict(chain_steps_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list["PromptUpdateChainStepsType0Item"]], data)
        ...
        def _parse_extra_metadata(data: object) -> Union["PromptUpdateExtraMetadataType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extra_metadata_type_0 = PromptUpdateExtraMetadataType0.from_dict(data)

                return extra_metadata_type_0
            except:  # noqa: E722
                pass
            return cast(Union["PromptUpdateExtraMetadataType0", None, Unset], data)
