...
T = TypeVar("T", bound="RoleToolAccessCreate")


@_attrs_define
class RoleToolAccessCreate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        role_tool_access_create.additional_properties = d
        return role_tool_access_create
