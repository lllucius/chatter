...
T = TypeVar("T", bound="ToolPermissionUpdate")
...
class ToolPermissionUpdate:
    ...
    Attributes:
        access_level (Union[None, ToolAccessLevel, Unset]):
    ...
    access_level: Union[None, ToolAccessLevel, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        access_level: Union[None, Unset, str]
        if isinstance(self.access_level, Unset):
            access_level = UNSET
        elif isinstance(self.access_level, ToolAccessLevel):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_access_level(data: object) -> Union[None, ToolAccessLevel, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                access_level_type_0 = ToolAccessLevel(data)

                return access_level_type_0
            except:  # noqa: E722
                pass
            return cast(Union[None, ToolAccessLevel, Unset], data)
        ...
        tool_permission_update.additional_properties = d
        return tool_permission_update
