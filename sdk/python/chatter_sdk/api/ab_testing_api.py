...
class ABTestingApi:
    ...
    async def end_ab_test_api_v1_ab_tests_test_id_end_post(
        self,
        test_id: StrictStr,
        winner_variant: Annotated[Optional[StrictStr], Field(description="Winning variant identifier")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        End A/B test and declare winner.  Args:     test_id: A/B test ID     current_user: Current authenticated user     ab_test_manager: A/B test manager instance     winner_variant: Optional winning variant identifier  Returns:     Action response

        :param test_id: (required)
        :type test_id: str
        :param winner_variant: Winning variant identifier
    ...
    @validate_call
    async def get_test_analytics_api_v1_ab_tests_test_id_analytics_get(
        self,
        test_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_test_analytics_api_v1_ab_tests_test_id_analytics_get_serialize(
            test_id=test_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_test_analytics_api_v1_ab_tests_test_id_analytics_get_with_http_info(
        self,
        test_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ABTestAnalyticsResponse]:
        """Get Test Analytics
    ...
    @validate_call
    async def get_test_analytics_api_v1_ab_tests_test_id_analytics_get_without_preload_content(
        self,
        test_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_test_analytics_api_v1_ab_tests_test_id_analytics_get_serialize(
        self,
        test_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/ab-tests/{test_id}/analytics',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
