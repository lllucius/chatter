...
class AnalyticsApi:
    ...
    async def export_analytics_api_v1_analytics_export_post(
        ...
        metrics: Annotated[
            list[StrictStr],
            Field(description="List of metrics to export"),
        ],
        format: Annotated[
            StrictStr | None,
            Field(description="Export format (json, csv, xlsx)"),
        ] = None,
        start_date: Annotated[
            datetime | None,
            Field(description="Start date for analytics"),
        ] = None,
        end_date: Annotated[
            datetime | None, Field(description="End date for analytics")
        ] = None,
        period: Annotated[
            StrictStr | None,
            Field(
