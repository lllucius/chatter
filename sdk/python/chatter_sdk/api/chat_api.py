...
class ChatApi:
    ...
    async def delete_conversation_api_v1_chat_conversations_conversation_id_delete(
        ...
        conversation_id: Annotated[
            str,
            Field(
                min_length=1, strict=True, description="Conversation ID"
            ),
        ],
        _request_timeout: (
            None
    ...
    async def delete_message_api_v1_chat_conversations_conversation_id_messages_message_id_delete(
        ...
        message_id: Annotated[
            str,
            Field(min_length=1, strict=True, description="Message ID"),
        ],
        _request_timeout: (
            None
            | Annotated[StrictFloat, Field(gt=0)]
    ...
    async def get_conversation_api_v1_chat_conversations_conversation_id_get(
        ...
        include_messages: Annotated[
            StrictBool | None,
            Field(description="Include messages in response"),
        ] = None,
        _request_timeout: (
            None
            | Annotated[StrictFloat, Field(gt=0)]
    ...
    async def get_mcp_status_api_v1_chat_mcp_status_get(
        ...
        _param = (
            self._get_mcp_status_api_v1_chat_mcp_status_get_serialize(
                _request_auth=_request_auth,
                _content_type=_content_type,
                _headers=_headers,
                _host_index=_host_index,
    ...
    async def streaming_chat_api_v1_chat_streaming_post(
        ...
        _param = (
            self._streaming_chat_api_v1_chat_streaming_post_serialize(
                chat_request=chat_request,
                _request_auth=_request_auth,
                _content_type=_content_type,
                _headers=_headers,
