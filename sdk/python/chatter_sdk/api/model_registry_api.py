...
class ModelRegistryApi:
    ...
    async def get_model_api_v1_models_models_model_id_get(
        ...
        _param = (
            self._get_model_api_v1_models_models_model_id_get_serialize(
                model_id=model_id,
                _request_auth=_request_auth,
                _content_type=_content_type,
                _headers=_headers,
    ...
    async def list_embedding_spaces_api_v1_models_embedding_spaces_get(
        self,
        model_id: Annotated[
            StrictStr | None, Field(description="Filter by model ID")
        ] = None,
        page: Annotated[
        ...
        active_only: Annotated[
            StrictBool | None,
            Field(description="Show only active spaces"),
        ] = None,
        _request_timeout: (
            None
            | Annotated[StrictFloat, Field(gt=0)]
    ...
    async def list_models_api_v1_models_models_get(
        ...
        provider_id: Annotated[
            StrictStr | None, Field(description="Filter by provider ID")
        ] = None,
        model_type: Annotated[
            ModelType | None, Field(description="Filter by model type")
        ] = None,
        page: Annotated[
            Annotated[int, Field(strict=True, ge=1)] | None,
            Field(description="Page number"),
        ...
        active_only: Annotated[
            StrictBool | None,
            Field(description="Show only active models"),
        ] = None,
        _request_timeout: (
            None
            | Annotated[StrictFloat, Field(gt=0)]
    ...
    async def list_providers_api_v1_models_providers_get(
        ...
        active_only: Annotated[
            StrictBool | None,
            Field(description="Show only active providers"),
        ] = None,
        _request_timeout: (
            None
            | Annotated[StrictFloat, Field(gt=0)]
        ...
        _param = (
            self._list_providers_api_v1_models_providers_get_serialize(
                page=page,
                per_page=per_page,
                active_only=active_only,
                _request_auth=_request_auth,
