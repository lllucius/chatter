...
class PluginsApi:
    ...
    async def get_plugin_api_v1_plugins_plugin_id_get(
        ...
        _param = (
            self._get_plugin_api_v1_plugins_plugin_id_get_serialize(
                plugin_id=plugin_id,
                _request_auth=_request_auth,
                _content_type=_content_type,
                _headers=_headers,
    ...
    async def get_plugin_stats_api_v1_plugins_stats_get(
        ...
        _param = (
            self._get_plugin_stats_api_v1_plugins_stats_get_serialize(
                _request_auth=_request_auth,
                _content_type=_content_type,
                _headers=_headers,
                _host_index=_host_index,
    ...
    async def install_plugin_api_v1_plugins_install_post(
        ...
        _param = (
            self._install_plugin_api_v1_plugins_install_post_serialize(
    ...
    async def update_plugin_api_v1_plugins_plugin_id_put(
        ...
        _param = (
            self._update_plugin_api_v1_plugins_plugin_id_put_serialize(
                plugin_id=plugin_id,
