...
class WorkflowsApi:
    ...
    async def execute_chat_workflow_api_v1_workflows_execute_chat_post(
        self,
        chat_workflow_request: Dict[str, Any],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param chat_workflow_request: Chat workflow request (required)
        :type chat_workflow_request: Dict[str, Any]
        :param _request_timeout: timeout setting for this request
        :type _request_timeout: int, tuple(int, int), optional
        :param _request_auth: set to override the auth_settings for a single request
        :type _request_auth: dict, optional
        :param _content_type: force content-type for the request
        :type _content_type: str, Optional
