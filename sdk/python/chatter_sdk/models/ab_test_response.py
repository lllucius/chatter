...
class ABTestResponse(BaseModel):
    ...
    min_sample_size: StrictInt = Field(
        description="Minimum sample size"
    )
    confidence_level: StrictFloat | StrictInt = Field(
        description="Statistical confidence level"
    )
    target_audience: dict[str, Any] | None = None
    traffic_percentage: StrictFloat | StrictInt = Field(
        description="Percentage of traffic included"
    )
    start_date: datetime | None = None
    end_date: datetime | None = None
    participant_count: StrictInt | None = Field(
        default=0, description="Number of participants"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "participant_count": (
                    obj.get("participant_count")
                    if obj.get("participant_count") is not None
                    else 0
                ),
