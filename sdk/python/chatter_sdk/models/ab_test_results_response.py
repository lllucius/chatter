...
class ABTestResultsResponse(BaseModel):
    ...
    statistical_significance: dict[str, StrictBool] = Field(
        description="Statistical significance by metric"
    )
    confidence_intervals: dict[
        str, dict[str, list[StrictFloat | StrictInt]]
    ] = Field(description="Confidence intervals")
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            self.winning_variant is None
            and "winning_variant" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "metrics": (
                    [
                        TestMetric.from_dict(_item)
                        for _item in obj["metrics"]
                    ]
                    if obj.get("metrics") is not None
                    else None
                ),
                "statistical_significance": obj.get(
                    "statistical_significance"
                ),
