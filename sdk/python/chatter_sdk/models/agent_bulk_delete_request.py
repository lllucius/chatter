...
class AgentBulkDeleteRequest(BaseModel):
    ...
    agent_ids: Annotated[
        list[StrictStr], Field(min_length=1, max_length=50)
    ] = Field(description="List of agent IDs to delete (max 50)")
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"agent_ids": obj.get("agent_ids")})
        return _obj
