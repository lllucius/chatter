...
class AgentResponse(BaseModel):
    ...
    personality_traits: list[StrictStr] = Field(
        description="Agent personality traits"
    )
    knowledge_domains: list[StrictStr] = Field(
    ...
    available_tools: list[StrictStr] = Field(
    ...
    temperature: StrictFloat | StrictInt = Field(
        description="Temperature for responses"
    )
    max_tokens: StrictInt = Field(description="Maximum tokens")
    max_conversation_length: StrictInt = Field(
        description="Maximum conversation length"
    )
    context_window_size: StrictInt = Field(
        description="Context window size"
    )
    response_timeout: StrictInt = Field(
        description="Response timeout in seconds"
    )
    learning_enabled: StrictBool = Field(description="Learning enabled")
    feedback_weight: StrictFloat | StrictInt = Field(
        description="Feedback weight"
    )
    adaptation_threshold: StrictFloat | StrictInt = Field(
