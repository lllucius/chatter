...
class AgentUpdateRequest(BaseModel):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.personality_traits is None
            and "personality_traits" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.knowledge_domains is None
            and "knowledge_domains" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.response_style is None
            and "response_style" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "capabilities" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.primary_llm is None
            and "primary_llm" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.fallback_llm is None
            and "fallback_llm" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "temperature" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "max_tokens" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.max_conversation_length is None
            and "max_conversation_length" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.context_window_size is None
            and "context_window_size" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.response_timeout is None
            and "response_timeout" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.learning_enabled is None
            and "learning_enabled" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.feedback_weight is None
            and "feedback_weight" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.adaptation_threshold is None
            and "adaptation_threshold" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "metadata" in self.model_fields_set
        ):
            _dict['metadata'] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "max_conversation_length": obj.get(
                    "max_conversation_length"
                ),
