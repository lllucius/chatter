...
class ChartDataPoint(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Data point label")
    value: Union[StrictFloat, StrictInt] = Field(description="Data point value")
    color: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "value", "color"]
