...
class ConversationWithMessages(BaseModel):
    ...
    enable_retrieval: StrictBool = Field(
    ...
    retrieval_score_threshold: StrictFloat | StrictInt = Field(
    ...
    messages: list[MessageResponse] | None = Field(
        default=None, description="Conversation messages"
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            ...
            and "last_message_at" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "messages": (
                    [
                        MessageResponse.from_dict(_item)
