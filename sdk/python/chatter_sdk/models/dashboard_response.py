...
class DashboardResponse(BaseModel):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.conversation_stats:
            _dict['conversation_stats'] = (
                self.conversation_stats.to_dict()
            )
        ...
        if self.document_analytics:
            _dict['document_analytics'] = (
                self.document_analytics.to_dict()
            )
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "conversation_stats": (
                    ConversationStatsResponse.from_dict(
                        obj["conversation_stats"]
                    )
                    if obj.get("conversation_stats") is not None
                    else None
                ),
                "usage_metrics": (
                    UsageMetricsResponse.from_dict(obj["usage_metrics"])
                    if obj.get("usage_metrics") is not None
                    else None
                ),
                "performance_metrics": (
                    PerformanceMetricsResponse.from_dict(
                        obj["performance_metrics"]
                    )
                    if obj.get("performance_metrics") is not None
                    else None
                ),
                "document_analytics": (
                    DocumentAnalyticsResponse.from_dict(
                        obj["document_analytics"]
                    )
                    if obj.get("document_analytics") is not None
                    else None
                ),
                "system_health": (
                    SystemAnalyticsResponse.from_dict(
                        obj["system_health"]
                    )
                    if obj.get("system_health") is not None
                    else None
                ),
