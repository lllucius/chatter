...
class DocumentAnalyticsResponse(BaseModel):
    ...
    total_documents: StrictInt = Field(
        description="Total number of documents"
    )
    documents_by_status: dict[str, StrictInt] = Field(
        description="Documents by processing status"
    )
    documents_by_type: dict[str, StrictInt] = Field(
        description="Documents by file type"
    )
    avg_processing_time_seconds: StrictFloat | StrictInt = Field(
        description="Average processing time"
    )
    processing_success_rate: StrictFloat | StrictInt = Field(
        description="Processing success rate"
    )
    total_chunks: StrictInt = Field(
        description="Total number of chunks"
    )
    avg_chunks_per_document: StrictFloat | StrictInt = Field(
        description="Average chunks per document"
    )
    total_storage_bytes: StrictInt = Field(
        description="Total storage used"
    )
    avg_document_size_bytes: StrictFloat | StrictInt = Field(
        description="Average document size"
    )
    storage_by_type: dict[str, StrictInt] = Field(
        description="Storage usage by document type"
    )
    total_searches: StrictInt = Field(
        description="Total number of searches"
    )
    avg_search_results: StrictFloat | StrictInt = Field(
        description="Average search results returned"
    )
    popular_search_terms: dict[str, StrictInt] = Field(
    ...
    documents_by_access_level: dict[str, StrictInt] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "avg_processing_time_seconds": obj.get(
                    "avg_processing_time_seconds"
                ),
                "processing_success_rate": obj.get(
                    "processing_success_rate"
                ),
                "total_chunks": obj.get("total_chunks"),
                "avg_chunks_per_document": obj.get(
                    "avg_chunks_per_document"
                ),
                "total_storage_bytes": obj.get("total_storage_bytes"),
                "avg_document_size_bytes": obj.get(
                    "avg_document_size_bytes"
                ),
                ...
                "most_viewed_documents": obj.get(
                    "most_viewed_documents"
                ),
                "documents_by_access_level": obj.get(
                    "documents_by_access_level"
                ),
            }
        )
