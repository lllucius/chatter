...
class DocumentResponse(BaseModel):
    ...
    is_public: StrictBool | None = Field(
        default=False, description="Whether document is public"
    )
    ...
    original_filename: StrictStr = Field(
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            ...
            and "processing_completed_at" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "processing_error" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.parent_document_id is None
            and "parent_document_id" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.last_accessed_at is None
            and "last_accessed_at" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "processing_completed_at": obj.get(
                    "processing_completed_at"
                ),
