...
class DocumentSearchRequest(BaseModel):
    ...
    score_threshold: (
        ...
        | None
    ) = Field(default=0.5, description="Minimum similarity score")
    document_types: list[DocumentType] | None = None
    tags: list[StrictStr] | None = None
    include_content: StrictBool | None = Field(
        default=False, description="Include document content in results"
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            self.document_types is None
            and "document_types" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "tags": obj.get("tags"),
                "include_content": (
                    obj.get("include_content")
                    if obj.get("include_content") is not None
                    else False
                ),
            }
        )
