...
class EmbeddingSpaceUpdate(BaseModel):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.reduction_strategy is None
            and "reduction_strategy" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.normalize_vectors is None
            and "normalize_vectors" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.distance_metric is None
            and "distance_metric" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.index_type is None
            and "index_type" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.index_config is None
            and "index_config" in self.model_fields_set
        ):
