...
class ExportDataRequest(BaseModel):
    ...
    include_metadata: StrictBool | None = Field(
        default=True, description="Include metadata"
    )
    compress: StrictBool | None = Field(
        default=True, description="Compress export file"
    )
    encrypt: StrictBool | None = Field(
        default=False, description="Encrypt export file"
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            ...
            and "date_from" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.custom_query is None
            and "custom_query" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "include_metadata": (
                    obj.get("include_metadata")
                    if obj.get("include_metadata") is not None
                    else True
                ),
                "compress": (
                    obj.get("compress")
