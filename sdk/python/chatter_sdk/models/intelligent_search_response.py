...
class IntelligentSearchResponse(BaseModel):
    ...
    suggestions: List[StrictStr] = Field(description="Search suggestions")
    analytics: Dict[str, Any] = Field(description="Search analytics")
    response_time_ms: Union[StrictFloat, StrictInt] = Field(description="Response time in milliseconds")
    __properties: ClassVar[List[str]] = ["query", "results", "suggestions", "analytics", "response_time_ms"]
