...
class JobResponse(BaseModel):
    ...
    ) = Field(default=0, description="Job progress percentage")
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            ...
            and "scheduled_at" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.progress_message is None
            and "progress_message" in self.model_fields_set
        ):
