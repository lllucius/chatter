    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            ...
            and "default_value" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "min_value" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "min_value": (
                    MinValue.from_dict(obj["min_value"])
                    if obj.get("min_value") is not None
                    else None
                ),
                "max_value": (
                    MaxValue.from_dict(obj["max_value"])
