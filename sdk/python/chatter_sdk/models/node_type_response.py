...
class NodeTypeResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "name", "description", "category", "properties", "icon", "color"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": [NodePropertyDefinition.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None,
            "icon": obj.get("icon"),
            "color": obj.get("color")
        })
        return _obj
