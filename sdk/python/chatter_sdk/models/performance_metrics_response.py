...
class PerformanceMetricsResponse(BaseModel):
    ...
    avg_response_time_ms: StrictFloat | StrictInt = Field(
        description="Average response time"
    )
    median_response_time_ms: StrictFloat | StrictInt = Field(
        description="Median response time"
    )
    p95_response_time_ms: StrictFloat | StrictInt = Field(
        description="95th percentile response time"
    )
    p99_response_time_ms: StrictFloat | StrictInt = Field(
        description="99th percentile response time"
    )
    requests_per_minute: StrictFloat | StrictInt = Field(
        description="Average requests per minute"
    )
    tokens_per_minute: StrictFloat | StrictInt = Field(
        description="Average tokens per minute"
    )
    total_errors: StrictInt = Field(
        description="Total number of errors"
    )
    error_rate: StrictFloat | StrictInt = Field(
        description="Error rate percentage"
    )
    errors_by_type: dict[str, StrictInt] = Field(
        description="Errors grouped by type"
    )
    performance_by_model: dict[
        str, dict[str, StrictFloat | StrictInt]
    ] = Field(description="Performance metrics by model")
    performance_by_provider: dict[
        str, dict[str, StrictFloat | StrictInt]
    ] = Field(description="Performance metrics by provider")
    database_response_time_ms: StrictFloat | StrictInt = Field(
        description="Average database response time"
    )
    vector_search_time_ms: StrictFloat | StrictInt = Field(
        description="Average vector search time"
    )
    embedding_generation_time_ms: StrictFloat | StrictInt = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "median_response_time_ms": obj.get(
                    "median_response_time_ms"
                ),
                ...
                "performance_by_provider": obj.get(
                    "performance_by_provider"
                ),
                "database_response_time_ms": obj.get(
                    "database_response_time_ms"
                ),
                "vector_search_time_ms": obj.get(
                    "vector_search_time_ms"
                ),
                "embedding_generation_time_ms": obj.get(
                    "embedding_generation_time_ms"
                ),
            }
        )
