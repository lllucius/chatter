...
class ProfileStatsResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "most_used_profiles": [ProfileResponse.from_dict(_item) for _item in obj["most_used_profiles"]] if obj.get("most_used_profiles") is not None else None,
            "recent_profiles": [ProfileResponse.from_dict(_item) for _item in obj["recent_profiles"]] if obj.get("recent_profiles") is not None else None,
