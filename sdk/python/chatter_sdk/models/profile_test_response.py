...
class ProfileTestResponse(BaseModel):
    ...
    response_time_ms: StrictInt = Field(
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            self.retrieval_results is None
            and "retrieval_results" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.tools_used is None
            and "tools_used" in self.model_fields_set
        ):
