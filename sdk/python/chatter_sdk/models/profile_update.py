...
class ProfileUpdate(BaseModel):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.profile_type is None
            and "profile_type" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "llm_provider" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.llm_model is None
            and "llm_model" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "context_window" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.memory_enabled is None
            and "memory_enabled" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.enable_retrieval is None
            and "enable_retrieval" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.retrieval_limit is None
            and "retrieval_limit" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.retrieval_score_threshold is None
            and "retrieval_score_threshold" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.enable_tools is None
            and "enable_tools" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.content_filter_enabled is None
            and "content_filter_enabled" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.stream_response is None
            and "stream_response" in self.model_fields_set
        ):
