...
class PromptCreate(BaseModel):
    ...
    content: Annotated[str, Field(min_length=1, strict=True)] = Field(
        description="Prompt content/template"
    )
    variables: list[StrictStr] | None = None
    template_format: StrictStr | None = Field(
        default='f-string',
    ...
    is_chain: StrictBool | None = Field(
        default=False, description="Whether this is a chain prompt"
    )
    chain_steps: list[dict[str, Any]] | None = None
    parent_prompt_id: StrictStr | None = None
    is_public: StrictBool | None = Field(
        default=False, description="Whether prompt is public"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "template_format": (
                    obj.get("template_format")
                    if obj.get("template_format") is not None
                    else 'f-string'
                ),
                ...
                "is_chain": (
                    obj.get("is_chain")
                    if obj.get("is_chain") is not None
                    else False
                ),
