...
class PromptResponse(BaseModel):
    ...
    total_tokens_used: StrictInt = Field(
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.variables is None
            and "variables" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "input_schema" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "output_schema" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "max_length" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "min_length" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.required_variables is None
            and "required_variables" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "examples" in self.model_fields_set
        ):
            _dict['examples'] = None
        ...
        # and model_fields_set contains the field
        if (
            self.test_cases is None
            and "test_cases" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.suggested_temperature is None
            and "suggested_temperature" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.suggested_max_tokens is None
            and "suggested_max_tokens" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.suggested_providers is None
            and "suggested_providers" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.chain_steps is None
            and "chain_steps" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.parent_prompt_id is None
            and "parent_prompt_id" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.changelog is None
            and "changelog" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.avg_response_time_ms is None
            and "avg_response_time_ms" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "last_used_at" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.avg_tokens_per_use is None
            and "avg_tokens_per_use" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "estimated_tokens" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "language" in self.model_fields_set
        ):
            _dict['language'] = None
