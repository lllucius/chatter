...
class PromptTestResponse(BaseModel):
    ...
    test_duration_ms: StrictInt = Field(
        description="Test execution time"
    )
    template_variables_used: list[StrictStr] = Field(
        description="Template variables actually used"
    )
    security_warnings: list[StrictStr] | None = Field(
        default=None, description="Security warnings if any"
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            self.rendered_content is None
            and "rendered_content" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "performance_metrics" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "template_variables_used": obj.get(
                    "template_variables_used"
                ),
