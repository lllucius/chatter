...
class PromptUpdate(BaseModel):
    ...
    content: Annotated[str, Field(min_length=1, strict=True)] | None = (
        None
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.prompt_type is None
            and "prompt_type" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.template_format is None
            and "template_format" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.is_chain is None
            and "is_chain" in self.model_fields_set
        ):
            _dict['is_chain'] = None
