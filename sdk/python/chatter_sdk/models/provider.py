...
class Provider(BaseModel):
    ...
    ] = Field(description="Unique provider name")
    ...
    api_key_required: StrictBool | None = Field(
    ...
    is_active: StrictBool | None = Field(
        default=True, description="Whether provider is active"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "api_key_required": (
                    obj.get("api_key_required")
                    if obj.get("api_key_required") is not None
                    else True
                ),
