...
class RestoreResponse(BaseModel):
    ...
    progress: (
        Annotated[int, Field(le=100, strict=True, ge=0)] | None
    ) = Field(default=0, description="Restore progress percentage")
    records_restored: StrictInt | None = Field(
        default=0, description="Number of records restored"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "records_restored": (
                    obj.get("records_restored")
                    if obj.get("records_restored") is not None
                    else 0
                ),
