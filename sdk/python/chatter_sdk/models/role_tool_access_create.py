...
class RoleToolAccessCreate(BaseModel):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            self.tool_pattern is None
            and "tool_pattern" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.server_pattern is None
            and "server_pattern" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.default_rate_limit_per_hour is None
            and "default_rate_limit_per_hour" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.default_rate_limit_per_day is None
            and "default_rate_limit_per_day" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.allowed_hours is None
            and "allowed_hours" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.allowed_days is None
            and "allowed_days" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "default_rate_limit_per_hour": obj.get(
                    "default_rate_limit_per_hour"
                ),
                "default_rate_limit_per_day": obj.get(
                    "default_rate_limit_per_day"
                ),
