...
class ServerToolResponse(BaseModel):
    ...
    bypass_when_unavailable: StrictBool | None = Field(
        default=False, description="Bypass when tool is unavailable"
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            ...
            and "args_schema" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.last_called is None
            and "last_called" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "last_error" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "bypass_when_unavailable": (
                    obj.get("bypass_when_unavailable")
                    if obj.get("bypass_when_unavailable") is not None
                    else False
                ),
                "id": obj.get("id"),
