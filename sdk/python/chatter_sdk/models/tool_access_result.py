...
class ToolAccessResult(BaseModel):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            self.rate_limit_remaining_hour is None
            and "rate_limit_remaining_hour" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.rate_limit_remaining_day is None
            and "rate_limit_remaining_day" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.restriction_reason is None
            and "restriction_reason" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "rate_limit_remaining_hour": obj.get(
                    "rate_limit_remaining_hour"
                ),
                "rate_limit_remaining_day": obj.get(
                    "rate_limit_remaining_day"
                ),
