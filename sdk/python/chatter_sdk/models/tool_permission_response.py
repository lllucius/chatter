    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            ...
            and "server_id" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.rate_limit_per_hour is None
            and "rate_limit_per_hour" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.rate_limit_per_day is None
            and "rate_limit_per_day" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.last_used is None
            and "last_used" in self.model_fields_set
        ):
