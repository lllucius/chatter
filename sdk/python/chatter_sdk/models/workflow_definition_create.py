...
class WorkflowDefinitionCreate(BaseModel):
    ...
    is_public: Optional[StrictBool] = Field(default=False, description="Whether workflow is publicly visible")
    tags: Optional[List[StrictStr]] = None
    template_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "description", "nodes", "edges", "metadata", "is_public", "tags", "template_id"]
