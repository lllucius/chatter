...
class WorkflowDefinitionFromTemplateRequest(BaseModel):
    ...
    """ # noqa: E501
    template_id: StrictStr = Field(description="Template ID to instantiate")
    name_suffix: Optional[StrictStr] = None
    user_input: Optional[Dict[str, Any]] = None
    is_temporary: Optional[StrictBool] = Field(default=True, description="Whether this is a temporary definition for execution")
    __properties: ClassVar[List[str]] = ["template_id", "name_suffix", "user_input", "is_temporary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "is_temporary": obj.get("is_temporary") if obj.get("is_temporary") is not None else True
        })
        return _obj
