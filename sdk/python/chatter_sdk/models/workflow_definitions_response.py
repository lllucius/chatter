...
class WorkflowDefinitionsResponse(BaseModel):
    ...
    total_count: StrictInt = Field(description="Total number of definitions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "definitions": [WorkflowDefinitionResponse.from_dict(_item) for _item in obj["definitions"]] if obj.get("definitions") is not None else None,
