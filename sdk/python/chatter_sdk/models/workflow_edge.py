...
class WorkflowEdge(BaseModel):
    ...
    id: StrictStr = Field(description="Unique edge identifier")
    source: StrictStr = Field(description="Source node ID")
    target: StrictStr = Field(description="Target node ID")
    source_handle: StrictStr | None = Field(
        default=None, alias="sourceHandle"
    )
    target_handle: StrictStr | None = Field(
        default=None, alias="targetHandle"
    )
    type: StrictStr | None = None
    data: WorkflowEdgeData | None = None
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            ...
            and "source_handle" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.target_handle is None
            and "target_handle" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "type": obj.get("type"),
                "data": (
                    WorkflowEdgeData.from_dict(obj["data"])
