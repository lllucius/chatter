...
class WorkflowExecutionResponse(BaseModel):
    ...
    execution_time_ms: StrictInt | None = None
    output_data: dict[str, Any] | None = None
    error_message: StrictStr | None = None
    tokens_used: StrictInt | None = Field(
        default=0, description="Total tokens used"
    )
    cost: StrictFloat | StrictInt | None = Field(
        default=0.0, description="Total cost"
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            ...
            and "execution_time_ms" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "output_data" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "created_at" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "updated_at" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "tokens_used": (
                    obj.get("tokens_used")
                    if obj.get("tokens_used") is not None
                    else 0
                ),
                "cost": (
                    obj.get("cost")
