...
class WorkflowNode(BaseModel):
    ...
    position: Dict[str, Union[StrictFloat, StrictInt]] = Field(description="Node position (x, y)")
    data: WorkflowNodeData
    selected: Optional[StrictBool] = None
    dragging: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["id", "type", "position", "data", "selected", "dragging"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": WorkflowNodeData.from_dict(obj["data"]) if obj.get("data") is not None else None,
