...
class WorkflowTemplateDirectExecutionRequest(BaseModel):
    ...
    """ # noqa: E501
    template: Dict[str, Any] = Field(description="Template data to execute")
    input_data: Optional[Dict[str, Any]] = None
    debug_mode: Optional[StrictBool] = Field(default=False, description="Enable debug mode")
    __properties: ClassVar[List[str]] = ["template", "input_data", "debug_mode"]
