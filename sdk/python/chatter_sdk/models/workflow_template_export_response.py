...
class WorkflowTemplateExportResponse(BaseModel):
    ...
    """ # noqa: E501
    template: Dict[str, Any] = Field(description="Complete template data including metadata")
    export_format: Optional[StrictStr] = Field(default='json', description="Export format version")
    exported_at: datetime = Field(description="Export timestamp")
    __properties: ClassVar[List[str]] = ["template", "export_format", "exported_at"]
