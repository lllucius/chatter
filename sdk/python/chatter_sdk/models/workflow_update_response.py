...
class WorkflowUpdateResponse(BaseModel):
    ...
    status: StrictStr = Field(description="Update status")
    message: StrictStr = Field(description="Update message")
    updated_fields: List[StrictStr] = Field(description="Fields that were updated")
    __properties: ClassVar[List[str]] = ["workflow_id", "status", "message", "updated_fields"]
