...
class WorkflowValidationResponse(BaseModel):
    ...
    """ # noqa: E501
    is_valid: StrictBool = Field(description="Whether workflow is valid")
    ...
    suggestions: List[StrictStr] = Field(description="Validation suggestions")
    __properties: ClassVar[List[str]] = ["is_valid", "errors", "warnings", "suggestions"]
