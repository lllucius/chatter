...
# **get_trending_content_api_v1_analytics_search_trending_get**
...
# **stop_real_time_dashboard_api_v1_analytics_real_time_dashboard_stop_post**
> Dict[str, object] stop_real_time_dashboard_api_v1_analytics_real_time_dashboard_stop_post()
...
async with chatter_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Stop Real Time Dashboard
        api_response = await api_instance.stop_real_time_dashboard_api_v1_analytics_real_time_dashboard_stop_post()
        print("The response of AnalyticsApi->stop_real_time_dashboard_api_v1_analytics_real_time_dashboard_stop_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AnalyticsApi->stop_real_time_dashboard_api_v1_analytics_real_time_dashboard_stop_post: %s\n" % e)
```
