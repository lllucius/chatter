...
class TestChatApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_chat_with_template_api_v1_chat_template_template_name_post(self) -> None:
    ...
    async def test_get_mcp_status_api_v1_chat_mcp_status_get(self) -> None:
    ...
    async def test_get_performance_stats_api_v1_chat_performance_stats_get(self) -> None:
    ...
    async def test_get_workflow_templates_api_v1_chat_templates_get(self) -> None:
