...
class TestChatResponse1(unittest.TestCase):
    """ChatResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatResponse1:
        """Test ChatResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatResponse1`
        """
        model = ChatResponse1()
        if include_optional:
