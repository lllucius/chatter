...
class TestChatWorkflowConfigOutput(unittest.TestCase):
    """ChatWorkflowConfigOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatWorkflowConfigOutput:
        """Test ChatWorkflowConfigOutput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatWorkflowConfigOutput`
        """
        model = ChatWorkflowConfigOutput()
        if include_optional:
            return ChatWorkflowConfigOutput(
    ...
    def testChatWorkflowConfigOutput(self):
        """Test ChatWorkflowConfigOutput"""
