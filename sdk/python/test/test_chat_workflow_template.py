...
class TestChatWorkflowTemplate(unittest.TestCase):
    """ChatWorkflowTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatWorkflowTemplate:
        """Test ChatWorkflowTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatWorkflowTemplate`
        """
        model = ChatWorkflowTemplate()
        if include_optional:
            return ChatWorkflowTemplate(
                name = '',
                description = '',
    ...
    def testChatWorkflowTemplate(self):
        """Test ChatWorkflowTemplate"""
