...
class TestPromptStatsResponse(unittest.TestCase):
    """PromptStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PromptStatsResponse:
        """Test PromptStatsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PromptStatsResponse`
        """
        model = PromptStatsResponse()
        if include_optional:
    ...
    def testPromptStatsResponse(self):
        """Test PromptStatsResponse"""
