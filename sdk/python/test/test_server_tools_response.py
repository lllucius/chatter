...
class TestServerToolsResponse(unittest.TestCase):
    """ServerToolsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServerToolsResponse:
        """Test ServerToolsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServerToolsResponse`
        """
    ...
    def testServerToolsResponse(self):
        """Test ServerToolsResponse"""
