...
os.environ.setdefault(
    ...
    "m7y0DnHHivzNFy4GH8VbiBSrG6r-NAA8KDyfB5CzUEo=",
)  # Set proper Fernet key for crypto tests
...
async def db_engine():
    ...
    async with engine.begin() as conn:
        try:
            ...
            print(
                f"Schema setup error (may be normal if tables exist): {e}"
            )
...
def setup_test_environment():
    ...
    config_modules = [
        ...
        if name and name.startswith('chatter.config')
    ]
