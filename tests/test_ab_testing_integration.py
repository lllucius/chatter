...
class TestABTestingIntegration:
    ...
    async def test_ab_test_complete_lifecycle(self, client: AsyncClient, auth_headers: dict, db_session: AsyncSession):
        ...
        get_response = await client.get(f"/api/v1/ab-tests/{test_id}", headers=auth_headers)
        assert get_response.status_code == 200
        assert get_response.json()["status"] == "draft"
        
        # Start test
        start_response = await client.post(f"/api/v1/ab-tests/{test_id}/start", headers=auth_headers)
        ...
        # Pause test
        pause_response = await client.post(f"/api/v1/ab-tests/{test_id}/pause", headers=auth_headers)
        assert pause_response.status_code == 200
        
        # Complete test
        complete_response = await client.post(f"/api/v1/ab-tests/{test_id}/complete", headers=auth_headers)
        assert complete_response.status_code == 200
        
        # Get final results
        results_response = await client.get(f"/api/v1/ab-tests/{test_id}/results", headers=auth_headers)
        assert results_response.status_code == 200
        
        # Delete test
        delete_response = await client.delete(f"/api/v1/ab-tests/{test_id}", headers=auth_headers)
    ...
    async def test_ab_test_list_and_filter(self, client: AsyncClient, auth_headers: dict, db_session: AsyncSession):
        ...
        # List all tests
        list_response = await client.get("/api/v1/ab-tests/", headers=auth_headers)
        ...
        # Test pagination
        page_response = await client.get("/api/v1/ab-tests/?page=1&per_page=2", headers=auth_headers)
        ...
        for test_id in created_tests:
            await client.delete(f"/api/v1/ab-tests/{test_id}", headers=auth_headers)
    ...
    async def test_ab_test_update_workflow(self, client: AsyncClient, auth_headers: dict, db_session: AsyncSession):
        ...
        update_response = await client.put(f"/api/v1/ab-tests/{test_id}", json=update_data, headers=auth_headers)
    ...
    async def test_ab_test_metrics_and_performance(self, client: AsyncClient, auth_headers: dict, db_session: AsyncSession):
        ...
        # Start test
        await client.post(f"/api/v1/ab-tests/{test_id}/start", headers=auth_headers)
        
        # Get metrics
        metrics_response = await client.get(f"/api/v1/ab-tests/{test_id}/metrics", headers=auth_headers)
        ...
        performance_response = await client.get(f"/api/v1/ab-tests/{test_id}/performance", headers=auth_headers)
        ...
        # Get recommendations
        recommendations_response = await client.get(f"/api/v1/ab-tests/{test_id}/recommendations", headers=auth_headers)
        ...
        # Clean up
        await client.post(f"/api/v1/ab-tests/{test_id}/complete", headers=auth_headers)
        await client.delete(f"/api/v1/ab-tests/{test_id}", headers=auth_headers)
    ...
    async def test_ab_test_state_validation(self, client: AsyncClient, auth_headers: dict, db_session: AsyncSession):
        ...
        start_again_response = await client.post(f"/api/v1/ab-tests/{test_id}/start", headers=auth_headers)
        assert start_again_response.status_code == 400
        
        # Try to delete running test (should fail)
        delete_running_response = await client.delete(f"/api/v1/ab-tests/{test_id}", headers=auth_headers)
    ...
    async def test_ab_test_concurrent_operations(self, client: AsyncClient, auth_headers: dict, db_session: AsyncSession):
        ...
        for test_id in created_test_ids:
            ...
            operation_tasks.append(
                asyncio.create_task(client.post(f"/api/v1/ab-tests/{test_id}/start", headers=auth_headers))
            )
        ...
        for test_id in created_test_ids:
            cleanup_tasks.extend([
                asyncio.create_task(client.post(f"/api/v1/ab-tests/{test_id}/complete", headers=auth_headers)),
                asyncio.create_task(client.delete(f"/api/v1/ab-tests/{test_id}", headers=auth_headers))
            ])
    ...
    async def test_ab_test_data_persistence(self, client: AsyncClient, auth_headers: dict, db_session: AsyncSession):
        ...
        assert retrieved_test["description"] == "Testing data persistence"
        ...
        get_response = await client.get(f"/api/v1/ab-tests/{test_id}", headers=auth_headers)
        assert get_response.json()["description"] == "Updated description for persistence test"
