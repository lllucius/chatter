...
class TestAnalyticsUnit:
    ...
    @pytest.mark.unit
    async def test_get_conversation_stats_requires_auth(
    ...
    @pytest.mark.unit
    async def test_get_usage_metrics_requires_auth(
        self, client: AsyncClient
    ):
    ...
    @pytest.mark.unit
    async def test_get_performance_metrics_requires_auth(
        self, client: AsyncClient
    ):
    ...
    @pytest.mark.unit
    async def test_get_document_analytics_requires_auth(
        self, client: AsyncClient
    ):
    ...
    @pytest.mark.unit
    async def test_get_system_analytics_requires_auth(
        self, client: AsyncClient
    ):
    ...
    @pytest.mark.unit
    async def test_get_toolserver_analytics_requires_auth(
        self, client: AsyncClient
    ):
    ...
    @pytest.mark.unit
    async def test_get_user_analytics_requires_auth(
        self, client: AsyncClient
    ):
    ...
    @pytest.mark.unit
    async def test_export_analytics_requires_auth(
        self, client: AsyncClient
    ):
    ...
    @pytest.mark.unit
    async def test_get_metrics_summary_requires_auth(
        self, client: AsyncClient
    ):
    ...
    async def test_get_document_analytics_success(
        ...
        mock_analytics = {
            ...
            "documents_by_type": {"pdf": 200, "docx": 150, "txt": 100},
        ...
        mock_service.get_document_analytics.return_value = (
            mock_analytics
        )
        mock_analytics_service.return_value = mock_service
    ...
    async def test_get_user_analytics_success(
        ...
        response = await client.get(
            "/api/v1/analytics/users/user-123", headers=auth_headers
        )
        assert response.status_code == 200
    ...
    async def test_analytics_service_error_handling(
        ...
        mock_service = AsyncMock()
        mock_service.get_conversation_stats.side_effect = Exception(
    ...
    async def test_invalid_user_id_format(
        ...
        response = await client.get(
            "/api/v1/analytics/users/invalid-user-id",
            headers=auth_headers,
        )
