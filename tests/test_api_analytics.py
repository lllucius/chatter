    ...
    def test_get_usage_metrics_success(self):
        ...
        with patch('chatter.api.auth.get_current_user') as mock_auth:
            ...
            with patch(
                ...
                headers = {"Authorization": "Bearer test-token"}
                response = self.client.get(
                    "/api/v1/analytics/usage", headers=headers
                )
    ...
    def test_get_performance_metrics_success(self):
        ...
        mock_metrics = {
            ...
            "slowest_endpoints": [
                ...
                {
                    "endpoint": "/api/v1/agents/interact",
                    "avg_time": 2.8,
                },
            ],
        }
    ...
    def test_get_document_analytics_success(self):
        ...
        with patch('chatter.api.auth.get_current_user') as mock_auth:
            ...
            with patch(
                ...
                mock_analytics = AsyncMock()
                mock_analytics.get_document_analytics.return_value = (
                    mock_analytics
                )
                mock_service.return_value = mock_analytics
                ...
                headers = {"Authorization": "Bearer test-token"}
                response = self.client.get(
                    "/api/v1/analytics/documents", headers=headers
                )
    ...
    def test_get_system_analytics_success(self):
        ...
        with patch('chatter.api.auth.get_current_user') as mock_auth:
            ...
            with patch(
                ...
                assert (
                    response_data["service_status"]["job_queue"]
                    == "degraded"
                )
    ...
    def test_get_dashboard_data_success(self):
        ...
        with patch('chatter.api.auth.get_current_user') as mock_auth:
            ...
            with patch(
                ...
                assert (
                    response_data["performance"]["system_health"]
                    == "healthy"
                )
    ...
    def test_analytics_invalid_period(self):
        ...
        with patch('chatter.api.auth.get_current_user') as mock_auth:
            ...
            with patch(
                ...
                mock_analytics = AsyncMock()
                mock_analytics.get_conversation_stats.side_effect = (
        ...
        with patch('chatter.api.auth.get_current_user') as mock_auth:
            ...
            with patch(
                ...
                assert (
                    ...
                    == dashboard_data["overview"]["total_conversations"]
                )
    ...
    def test_analytics_performance_tracking(self):
        ...
        with patch('chatter.api.auth.get_current_user') as mock_auth:
            ...
            with patch(
                ...
                assert (
                    0 <= response_data["avg_response_time"] <= 10
                )  # Reasonable response time
                assert (
                    0 <= response_data["error_rate"] <= 1
                )  # Error rate is a percentage
