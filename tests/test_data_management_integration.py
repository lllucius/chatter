...
class TestDataManagementIntegration:
    ...
    async def test_export_data_workflow(
        ...
        assert response.status_code in [
            ...
            422,
            500,
        ]  # 202 = Accepted, others = graceful failures
    ...
    async def test_backup_workflow(
        ...
        if response.status_code == 202:
            ...
            if backup_status_response.status_code == 200:
                ...
                assert backup_data["backup_id"] == backup_id
    ...
    @pytest.mark.integration
    async def test_restore_workflow(
        self, client: AsyncClient, auth_headers: dict
    ):
    ...
    @pytest.mark.integration
    async def test_storage_stats_workflow(
        self, client: AsyncClient, auth_headers: dict
    ):
    ...
    @pytest.mark.integration
    async def test_bulk_delete_conversations_workflow(
        self, client: AsyncClient, auth_headers: dict
    ):
    ...
    @pytest.mark.integration
    async def test_bulk_delete_prompts_workflow(
        self, client: AsyncClient, auth_headers: dict
    ):
    ...
    @pytest.mark.integration
    async def test_data_management_permission_workflow(
        self, client: AsyncClient, auth_headers: dict
    ):
    ...
    @pytest.mark.integration
    async def test_cross_api_data_consistency(
        self, client: AsyncClient, auth_headers: dict
    ):
        ...
        if (
            ...
            and storage_response.status_code == 200
        ):
            ...
            if (
                "total_documents" in doc_stats
                and "documents" in storage_stats
            ):
