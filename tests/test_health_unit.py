...
class TestHealthUnit:
    ...
    @pytest.mark.unit
    async def test_health_and_liveness_different_status(
    ...
    async def test_metrics_endpoint_without_monitoring(
        self, mock_monitoring, client: AsyncClient
    ):
    ...
    @pytest.mark.unit
    async def test_correlation_trace_without_monitoring(
        self, client: AsyncClient
    ):
    ...
    async def test_metrics_endpoint_with_monitoring_error(
        ...
        mock_get_monitoring.side_effect = Exception(
    ...
    async def test_correlation_trace_with_monitoring_error(
        ...
        assert (
            f"Failed to get trace for correlation ID: {correlation_id}"
            in data["detail"]
        )
