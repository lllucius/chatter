...
class TestAuthRateLimitMiddleware:
    ...
    @patch('chatter.middleware.auth_security.get_unified_rate_limiter')
    async def test_non_auth_endpoint_not_rate_limited(self, mock_get_limiter):
    ...
    @patch('chatter.middleware.auth_security.get_unified_rate_limiter')
    async def test_different_auth_endpoints_have_different_limits(self, mock_get_limiter):
        ...
        def mock_is_allowed(*args, **kwargs):
            ...
            if "password_reset" in str(args):
                return AsyncMock(return_value=(False, {"retry_after": 300}))()
            else:
...
class TestMiddlewareIntegration:
    ...
    def test_middleware_performance(self):
        ...
        assert (end_time - start_time) < 1.0  # Less than 1 second for 10 requests
...
class TestMiddlewareEdgeCases:
    ...
    @patch('chatter.middleware.auth_security.get_unified_rate_limiter')
    def test_rate_limit_middleware_with_none_client(self, mock_get_limiter):
