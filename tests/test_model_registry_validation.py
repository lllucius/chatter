...
from chatter.models.registry import ModelDef, ModelType
...
class TestModelValidation:
    ...
    def test_validate_model_consistency_embedding_without_dimensions(
        self, mock_service
    ):
        ...
        assert "Embedding models must specify dimensions" in str(
            exc_info.value
        )

    def test_validate_model_consistency_llm_with_dimensions(
        self, mock_service
    ):
        ...
        assert "LLM models should not specify dimensions" in str(
            exc_info.value
        )

    def test_validate_model_consistency_negative_max_tokens(
        self, mock_service
    ):
    ...
    def test_validate_model_consistency_batch_settings_conflict(
        self, mock_service
    ):
    ...
    def test_validate_model_consistency_valid_embedding_model(
        self, mock_service
    ):
    ...
    def test_validate_model_consistency_valid_llm_model(
        self, mock_service
    ):
