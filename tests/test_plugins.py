...
class TestBasePlugin:
    ...
    async def test_validate_configuration_error_handling(self):
        ...
        is_valid = await plugin.validate_configuration({"test": "config"})
        assert is_valid is False
...
'''
    ...
    async def test_unload_plugin_success(self):
        ...
        self.plugin_manager.plugin_instances["test_plugin"] = plugin_instance
    ...
    def test_list_plugins_by_type(self):
        ...
        self.plugin_manager.plugin_instances["tool_plugin"] = tool_plugin
        self.plugin_manager.plugin_instances["workflow_plugin"] = workflow_plugin
        
        tool_plugins = self.plugin_manager.list_plugins(plugin_type=PluginType.TOOL)
    ...
    def test_list_plugins_by_status(self):
        ...
        self.plugin_manager.plugin_instances["active_plugin"] = active_plugin
        self.plugin_manager.plugin_instances["error_plugin"] = error_plugin
        
        active_plugins = self.plugin_manager.list_plugins(status=PluginStatus.ACTIVE)
    ...
    def test_get_tools_from_plugins_inactive_ignored(self):
        ...
        self.plugin_manager.plugin_instances["inactive_plugin"] = inactive_plugin
    ...
    async def test_health_check_all_plugins(self):
        ...
        health_results = await self.plugin_manager.health_check_all_plugins()
    ...
    async def test_health_check_plugin_error(self):
        ...
        assert "Health check failed" in health_results["error_plugin"]["error"]
...
'''
        ...
        try:
            ...
            # Unload plugin
            result = await self.plugin_manager.unload_plugin("lifecycle_plugin")
            assert result is True
