...
class TestProfilesIntegration:
    ...
    async def test_profile_complete_lifecycle(
        self,
        client: AsyncClient,
        auth_headers: dict,
        ...
        # Verify clone
        clone_get_response = await client.get(
            f"/api/v1/profiles/{cloned_profile_id}",
            headers=auth_headers,
        )
        ...
        delete_clone_response = await client.delete(
            f"/api/v1/profiles/{cloned_profile_id}",
            headers=auth_headers,
        )
    ...
    @pytest.mark.integration
    async def test_profile_list_and_filter(
        self,
        client: AsyncClient,
        auth_headers: dict,
        db_session: AsyncSession,
        ...
        page_response = await client.get(
            "/api/v1/profiles?page=1&per_page=2", headers=auth_headers
        )
    ...
    @pytest.mark.integration
    async def test_profile_stats_and_providers(
        self,
        client: AsyncClient,
        auth_headers: dict,
        db_session: AsyncSession,
        ...
        assert (
            updated_stats["total_profiles"]
            >= initial_stats["total_profiles"]
        )
    ...
    @pytest.mark.integration
    async def test_profile_error_scenarios(
        self,
        client: AsyncClient,
        auth_headers: dict,
        db_session: AsyncSession,
    ...
    @pytest.mark.integration
    async def test_profile_data_validation(
        self,
        client: AsyncClient,
        auth_headers: dict,
        db_session: AsyncSession,
    ...
    @pytest.mark.integration
    async def test_profile_concurrent_operations(
        self,
        client: AsyncClient,
        auth_headers: dict,
        db_session: AsyncSession,
        ...
        operation_tasks.extend(
            [
                ...
                asyncio.create_task(
                    client.get("/api/v1/profiles", headers=auth_headers)
                ),
                asyncio.create_task(
                    client.get(
    ...
    @pytest.mark.integration
    async def test_profile_complex_data_handling(
        self,
        client: AsyncClient,
        auth_headers: dict,
        db_session: AsyncSession,
        ...
        assert (
            retrieved_profile["temperature"]
            == complex_profile_data["temperature"]
        )
        assert (
            retrieved_profile["max_tokens"]
            == complex_profile_data["max_tokens"]
        )
        assert (
            retrieved_profile["system_message"]
            == complex_profile_data["system_message"]
        )
    ...
    @pytest.mark.integration
    async def test_profile_testing_functionality(
        self,
        client: AsyncClient,
        auth_headers: dict,
        db_session: AsyncSession,
        ...
        test_scenarios = [
            ...
            {"message": "What is 2 + 2?", "include_metrics": False},
            {
