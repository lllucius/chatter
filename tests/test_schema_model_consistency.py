...
class TestSchemaModelConsistency:
    ...
    def test_user_registration_schema_matches_model_fields(self):
        ...
        assert not missing_in_model, f"Fields in schema but missing in model: {missing_in_model}"
    ...
    def test_user_model_required_fields_in_schemas(self):
        ...
        assert not missing_required, f"Required model fields missing in UserRegistration: {missing_required}"
    ...
    def test_phone_number_field_exists_in_user_model(self):
        ...
        assert "phone_number" in user_columns, "phone_number field is missing from User model but exists in schemas"
    ...
    def test_user_model_can_store_phone_number(self):
        ...
        try:
            ...
            pytest.fail(f"User model doesn't accept phone_number field: {e}")