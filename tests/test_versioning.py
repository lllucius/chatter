...
class TestVersionInfo:
    ...
    def test_version_info_creation(self):
        ...
        assert (
            version_info.documentation_url
            == "https://api.example.com/docs/v2"
        )
...
class TestAPIVersionManager:
    ...
    def test_add_version(self):
        ...
        assert (
            retrieved_info.documentation_url
            == "https://api.example.com/docs/v1-new"
        )
    ...
    def test_version_middleware_integration(self):
        ...
        async def version_middleware(request: Request, call_next):
            ...
            # Validate version
            version_enum = (
                APIVersion.V1 if api_version == "v1" else APIVersion.V2
            )
        ...
        response = client.get(
            "/api/test", headers={"API-Version": "v2"}
        )
        ...
        response = client.get(
            "/api/test", headers={"API-Version": "v1"}
        )
...
class TestVersioningIntegration:
    ...
    def test_complete_version_lifecycle(self):
        ...
        self.manager.register_endpoint(
            "/api/legacy", "GET", APIVersion.V1, APIVersion.V2
        )
        self.manager.register_endpoint(
        ...
        assert self.manager.is_endpoint_available(
            "/api/legacy", "GET", APIVersion.V1
        )
        assert not self.manager.is_endpoint_available(
            "/api/legacy", "GET", APIVersion.V2
        )
        assert self.manager.is_endpoint_available(
            "/api/stable", "GET", APIVersion.V1
        )
        ...
        assert not self.manager.is_endpoint_available(
            "/api/new", "GET", APIVersion.V1
        )
        assert self.manager.is_endpoint_available(
            "/api/new", "GET", APIVersion.V2
        )
    ...
    def test_version_migration_scenario(self):
        ...
        legacy_endpoints = ["/api/users", "/api/posts", "/api/comments"]

        for endpoint in legacy_endpoints:
            self.manager.register_endpoint(
                endpoint, "GET", APIVersion.V1
            )
            self.manager.register_endpoint(
                endpoint, "POST", APIVersion.V1
            )
        ...
        self.manager.register_endpoint(
            "/api/comments", "GET", APIVersion.V1, APIVersion.V2
        )  # Removed in V2
        self.manager.register_endpoint(
            "/api/threads", "GET", APIVersion.V2
        )  # New in V2
        self.manager.deprecate_endpoint(
            "/api/posts", "POST", APIVersion.V2
        )  # Deprecated in V2
