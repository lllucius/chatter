...
class TestAdvancedWorkflows:
    ...
    async def test_create_conditional_workflow(self):
        ...
        with patch('chatter.core.workflow_advanced.LangGraphWorkflowManager') as mock_manager_class:
            mock_manager = Mock()
            mock_manager.create_workflow.return_value = Mock()
            ...
            call_args = mock_manager.create_workflow.call_args[1]
